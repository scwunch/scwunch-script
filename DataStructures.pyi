...
class FuncBlock:
    ...
    def execute(self, args: list[Value] = None, scope: Function = None) -> Value: ...
...
class Function:
    ...
    def select(self, key: Pattern | list[Value] | str | int, walk_prototype_chain=True, ascend_env=False) -> Option: ...
...
class ListFunc(Function):
    def push(self, val: Value) -> ListFunc: ...
