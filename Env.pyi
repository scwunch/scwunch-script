...
class BindTargetName(BindTarget):
    name: str
    scope: Frame | Record | None
    def __init__(self, name: str, scope: Frame | Record = None): ...

class BindTargetKey(BindTarget):
    key: Record
    fn: Function | PyValue[list]
    def __init__(self, key: Record, fn: Function | PyValue[list]): ...