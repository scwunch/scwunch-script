...
class OptionCatalog:
    ...
    def __init__(self, options: dict[FlexiPatt, opt_resolution] = {}, *traits: Trait, default: opt_resolution = None): ...
    def assign_default(self, resolution: opt_resolution): ...
    def assign_option(self, pattern: FlexiPatt | Option, resolution: opt_resolution = None,
                      *, no_clobber=False, prioritize=False) -> Option: ...
...
class Record:
    ...
    truthy: bool = True
    value: any
    def __init__(self, cls, *data_tuple: Record, **data_dict: Record): ...
    def get(self, name: str, *default, search_class_frame_too=False) -> Record: ...
...
class PyValue(Record, Generic[T]):
    value: T
    def __init__(self, cls: Class, value: T): ...
...
class Map(Record, OptionCatalog):
    ...
    # getter_dict: dict[str, Map]
    # setter_dict: dict[str, Map]
    frame: Frame | None
    uninitialized: bool
    def __init__(self,
...
class Trait(Map):
    ...
    def __init__(self, options: dict[FlexiPatt, opt_resolution] = {},
                 *fields: Field,
                 ...
                 uninitialized=False,
                 default: opt_resolution = None): ... #, own_trait: Trait = None): ...
...
class Class(Map):
    ...
    traits: tuple[Trait, ...]  # the traits to be used by instances.  traits[0] is defined in the class body block
    catalog: OptionCatalog
    getters: dict[str, int | Map]
    setters: dict[str, int | Map]
    defaults: tuple[Map, ...]  # this is for instantiation of Records
...
class Field(Record):
    ...
    def __init__(self, name: str,
                 type: Pattern = None,
                 default: Map | None = py_value(None),
                 getter: Map = py_value(None)): ...

    # def get_data(self, rec: Record, idx: int): ...
    # def set_data(self, rec: Record, idx: int, value): ...

class Slot(Field):
    default: Map | None  # default should be a map with a single option with a single parameter: self
    def __init__(self, name: str, type: Pattern, default: Map = None): ...
    # def get_data(self, rec: Record, idx: int): ...
    # def set_data(self, rec: Record, idx: int, value): ...

class Getter(Field):
    getter: Map
    def __init__(self, name: str, type: Pattern, getter: Map | PyFunction): ...
    # def get_data(self, rec: Record, idx: int): ...
...
class Pattern(Record):
    ...
    def merge(self, binding: str, default: Record = None) -> BindingPattern: ...

class Matcher(Pattern):
    rank: tuple[int, int, ...]  # for sorting
    def __init__(self, name: str = None, guard: Map | PyFunction = None, inverse=False): ...
    def match(self, arg: Record) -> None | dict[str, Record]: ...
...
class ClassMatcher(Matcher):
    class_: Class
    def __init__(self, cls: Class, name: str = None, guard: Map | PyFunction = None, inverse=False): ...
    def __eq__(self, other): ...
    def __hash__(self): ...

class TraitMatcher(Matcher):
    trait: Trait
    def __init__(self, trait: Trait, name: str = None, guard: Map | PyFunction = None, inverse=False): ...

class ValueMatcher(Matcher):
    value: Record
    def __init__(self, value: Record, name: str = None, guard: Map | PyFunction = None, inverse=False): ...
    def __eq__(self, other): ...
    def __hash__(self): ...
...
@overload
def dot_set_fn(rec: Record, args: Args, value: Record,
               *, safe_set=False,
                  swizzle: PyValue | bool = False): ...

@overload
def dot_set_fn(rec: Record, name: str | PyValue[str], value: Record,
               *, safe_set=False,
                  swizzle: PyValue | bool = False): ...

@overload
def dot_set_fn(rec: Record, name: str | PyValue[str], args: Args, value: Record,
               *, safe_set=False,
                  swizzle: PyValue | bool = False): ...
...
class BindingPattern(Pattern):
    ...
    def merge(self, binding: str = None, default: Record = None) -> BindingPattern: ...
...
class BindKeyPattern(BindingPattern):
    rec: Map
    key: Args | ParamSet
    def __init__(self, rec: Map, key: Args | ParamSet, pattern: Pattern = AnyMatcher(), default: Record = None): ...
    def match_and_bind(self, arg: Record | Closure) -> Record: ...

class VarPatt(BindingPattern):
    var_name: str
    def __init__(self, name: str): ...
...
class ParamSet(Pattern):
    ...
    vm: list
    def __init__(self, *parameters: Parameter, named_params: dict[str, Parameter] = None, kwargs: str = None): ...
...
class PiliField(Record):
    name: str
    type: Pattern = None
    getter: Map | True = None
    setter: Map | True = None
    default: Record | None = None
    def __init__(self, field: Field): ...
    def wrap_default(self) -> Map: ...
