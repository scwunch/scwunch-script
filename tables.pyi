...
class OptionMap:
    ...
    options: list[Option]
    hashed_options: dict[tuple[Record, ...], Option]
    def __init__(self, options: dict[FlexiPatt, opt_resolution] = None): ...
    def add_option(self, pattern: FlexiPatt, resolution: opt_resolution = None) -> Option: ...
    def remove_option(self, pattern: FlexiPatt): ...
    def select_and_bind(self, key: list[Record] | tuple[Record], walk_prototype_chain=True, ascend_env=False) \
...
class Record:
    ...
    truthy: bool = True
    mro: tuple[OptionMap, ...]
    def __init__(self, table: Table, *slices: Slice, **data: Record): ...
...
class PyValue(Record, Generic[T]):
    value: T
    def __init__(self, table: Table, value: T, *slices: Slice): ...
...
class Table(Record):
    ...
    prototype: OptionMap  # contains all the heritable options
    def __init__(self, *field_tuple: Field, name: str = None): ...
